...
test_that("root cluster is detected", {
  root_cluster <- FindRootCluster(RSoptSC::GuoPtime$Params$cluster_label,
                                  RSoptSC::GuoPtime$Params$latent,
                                  RSoptSC::GuoPtime$Values$Short_pathd,
                                  RSoptSC::GuoPtime$Values$low_dis,
                                  reverse = FALSE)
