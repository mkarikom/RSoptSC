...
p <- PlotTopN_Grid(data = similarity_data,
              cluster_labels = labels,
              markers = markers$all,
              n_features = 15)
```
...
```{r, results='asis', warning=FALSE, message= FALSE, out.width = '100%', out.height = '100%', fig.width = 4, fig.heigt = 4}
  gene_list = c('Tgfb1', 'Tgfb2', 
                'Tgfbr1', 'Tgfbr2',
                'Zeb2','Smad2','Wnt4','Wnt11','Bmp7','Sox9','Notch1')

  p <- PlotClusterExpression(data = all_data,
                        cluster_labels = labels, 
                        markers = gene_list)
```