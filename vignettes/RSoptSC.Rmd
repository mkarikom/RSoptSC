...
* ligand-receptor interactions, eg. [`RSoptSC/inst/extdata/tgfb_lig_rec.tsv`](https://github.com/mkarikom/RSoptSC/blob/master/inst/extdata/tgfb_lig_rec.tsv)

* receptor-target interactions, eg. [`RSoptSC/inst/extdata/tgfb_rec_target.tsv`](https://github.com/mkarikom/RSoptSC/blob/master/inst/extdata/tgfb_rec_target.tsv)
